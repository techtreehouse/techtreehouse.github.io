...
document.addEventListener('keydown', function(event) {
    const element = document.querySelector('.custom-control-label'); // Replace with your specific element
    if (event.key === 'Enter' && document.activeElement === element) {
        element.click(); // Simulate a click when 'Enter' is pressed
    }
});
